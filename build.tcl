...
set fileurl "https://pilotfiber.dl.sourceforge.net/project/fbc/FreeBASIC-1.08.0/Documentation/FB-manual-$version-html.zip"
set var [list wget $fileurl -O FB-manual-$version-html.zip]
exec >@stdout 2>@stderr {*}$var

set fileurl "https://pilotfiber.dl.sourceforge.net/project/fbc/FreeBASIC-1.08.0/Source/FreeBASIC-$version-source.tar.xz"
set var [list wget $fileurl -O FreeBASIC-$version-source.tar.xz]
exec >@stdout 2>@stderr {*}$var

set fileurl "https://pilotfiber.dl.sourceforge.net/project/fbc/FreeBASIC-1.08.0/Source/FreeBASIC-$version-source-bootstrap.tar.xz"
